...
from memory_weave.models import Principal, Record, TurnRole
...
from memory_weave.util import normalize_ws, uuid7
...
class DeepAgentsMemoryAdapter:
    ...
    def middleware(self) -> MemoryWeaveMiddleware:
        return MemoryWeaveMiddleware(self)
...
class MemoryWeaveMiddleware(AgentMiddleware[Any, Any, Any]):
