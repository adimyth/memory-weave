...
from memory_weave.config import MemoryWeaveConfig, RewriteConfig
from memory_weave.hosted import CompletionClient, StructuredOutputError, completion_client_for, parse_json_object
...
class HostedLLMQueryRewriter:
    ...
    def __init__(self, client: CompletionClient, *, timeout_ms: int) -> None:
        ...
        self._system = files("memory_weave.retrieve").joinpath("prompts").joinpath("rewrite_v1.md").read_text("utf-8")
...
def rewriter_from_config(config: MemoryWeaveConfig) -> QueryRewriter:
