...
from retold.models import Entity, Principal, Record, Scope
from retold.policy.grants import readable_scopes
from retold.store import Store
from retold.util import normalize_ws


def _principal_entity(store: Store, principal: Principal, actor: str) -> Entity:
    # Imported here because retold.ingest.entities imports this package's grant rules.
    from retold.ingest.entities import ensure_principal_entity
...
class ActivationOperations:
    ...
    def backlog(self, *, max_open: int, max_age_days: float, at: object = None) -> BacklogStatus:
        ...
        from retold.util import now as _now
