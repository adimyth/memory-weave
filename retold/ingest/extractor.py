...
from retold.hosted import CompletionClient, StructuredOutputError, parse_json_object
...
def load_prompt(name: str) -> str:
    ...
    return files("retold.ingest").joinpath("prompts").joinpath(name).read_text(encoding="utf-8")
