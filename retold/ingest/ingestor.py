...
from retold.util import Timer, normalize_attribute, normalize_ws, now, render_subject, uuid7
...
def _authority_key(record: Record, config: RetoldConfig) -> tuple[int, datetime, datetime, str]:
